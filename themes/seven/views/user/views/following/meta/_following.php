...
$title      =   Module::t('following','following.head.title',['name'=>$user->getName()]);
$description=   Module::t('following','meta._following.description',['name'=>$user->getName(),'description'=>$user->getTagLine()]);
...
$this->registerMetaTag(['name'=>'og:url','content'=> Yii::$app->urlManager->createAbsoluteUrl("/{$user->getUsername()}/following")]);
