    ...
    <table bgcolor="" style="margin: 0;padding: 0;width: 100%; direction: rtl;">
        <tr style="margin: 0;padding: 0; direction: rtl;">
            <td class="small" width="20%" style="vertical-align: top;padding-right: 10px;margin: 0;padding: 0; direction: rtl;">
                <a href="<?= Yii::getAlias('@homeUrl').'/'.$comment->user->getUsername().'?utm_source=notification&utm_medium=image&utm_campaign=digest'; ?>">
            ...
            <td style="margin: 0;padding: 0; direction: rtl;">
                <p style="font-family: Arial, Tahoma, Helvetica, sans-serif;font-size:21px;font-weight: bold;margin: 0;padding: 0;line-height: 1.1;margin-bottom: 15px;color: #000; direction: rtl;">
                    <a style="text-decoration: none;" href="<?= Yii::getAlias('@homeUrl').'/'.$comment->user->getUsername().'?utm_source=notification&utm_medium=header&utm_campaign=digest'; ?>">
                        <?= $comment->user->getName();?>
                    </a>
                    <?= Module::t('mail','comment.digest.for'); ?>
                    <a style="text-decoration: none;" href="<?= Yii::getAlias('@homeUrl').'/'.$comment->post->user->getUsername().'/'.$comment->post->url.'?utm_source=notification&utm_medium=header&utm_campaign=digest'; ?>">
                        <?= $comment->post->title;?>
                    </a>                    
