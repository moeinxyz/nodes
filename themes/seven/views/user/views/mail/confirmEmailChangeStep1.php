                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" dir="rtl">
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                                <?= Module::t('mail','user.emailchange1.sent1',['email'=>$email]); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                                <?= Module::t('mail','user.emailchange1.sent2'); ?>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                                <br>
                                                <?= Module::t('mail','user.emailchange1.sent3'); ?>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
