    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-md-8 col-lg-offset-2">
            <div class="alert alert-success">
                ...
                <p><?= Html::a(Module::t('user','join.resend_activation.text'),  Yii::$app->urlManager->createUrl(['user/user/activation']));?></p>
            </div>            
        </div>
    </div>
<?php endif; ?>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4  col-lg-offset-2">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="<?= Yii::$app->urlManager->createUrl(['user/user/auth','authclient'=>'google']) ?>" target="_blank" class="btn btn-block btn-social btn-google-plus">
                    <i class="fa fa-google-plus"></i><?= Module::t('user', 'join.byGoogle'); ?>
                </a>
                <a href="<?= Yii::$app->urlManager->createUrl(['user/user/auth','authclient'=>'facebook']) ?>" target="_blank" class="btn btn-block btn-social btn-facebook">
                  <i class="fa fa-facebook"></i><?= Module::t('user', 'join.byFacebook'); ?>
                </a>
                <a href="<?= Yii::$app->urlManager->createUrl(['user/user/auth','authclient'=>'twitter']) ?>" target="_blank" class="btn btn-block btn-social btn-twitter">
                  <i class="fa fa-twitter"></i><?= Module::t('user', 'join.byTwitter'); ?>
                </a>        
                <a href="<?= Yii::$app->urlManager->createUrl(['user/user/auth','authclient'=>'linkedin']) ?>" target="_blank" class="btn btn-block btn-social btn-linkedin">
                  <i class="fa fa-linkedin"></i><?= Module::t('user', 'join.byLinkedin'); ?>
                </a>        
                <a  href="<?= Yii::$app->urlManager->createUrl(['user/user/auth','authclient'=>'github']) ?>" target="_blank" class="btn btn-block btn-social btn-github">
