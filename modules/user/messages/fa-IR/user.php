...
return [
    ...
    // setting
    'chgSetting.attr.content_activity'          =>  'فعالیت بر روی محتوی',
    ...
    'meta._join.description'                    =>  'به راحتی و رایگان در نودز عضو شوید.همچنین شما می توانید با استفاده از سرویس های گوگل،فیس بوک،توئتر،لینکدین و یا گیت هاب وارد نودز شوید. ',
